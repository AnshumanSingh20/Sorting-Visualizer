...
public final class Panel extends JPanel implements ActionListener {
    ...
    private final String[] algorithms = {"BubbleSort", "SelectionSort", "InsertionSort", "MergeSort", 
    "QuickSort","HeapSort","ShellSort","CountingSort","CycleSort","BucketSort"};
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == buttonRun) {
            ...
            switch (selected) {
                ...
                case "HeapSort" -> algorithm = new HeapSort(this);
                case "ShellSort" -> algorithm = new ShellSort(this);
                case "CountingSort" -> algorithm = new CountingSort(this);
                case "CycleSort" -> algorithm = new CycleSort(this);
                
                case "BucketSort" -> algorithm = new BucketSort(this);
